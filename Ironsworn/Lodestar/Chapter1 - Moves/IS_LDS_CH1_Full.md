...
> |  |  |
> | --- | :---: |
> | MOVES INDEX | [[#MOVES INDEX\|Page 6]] |
> | ADVENTURE MOVES | [[#ADVENTURE MOVES\|Page 8]] |
> | JOURNEY MOVES | [[#JOURNEY MOVES\|Page 10]] |
> | SCENE CHALLENGE MOVES | [[#SCENE CHALLENGE MOVES\|Page 11]] |
> | QUEST MOVES | [[#QUEST MOVES\|Page 12]] |
> | FATE MOVES | [[#FATE MOVES\|Page 13]] |
> | RELATIONSHIP MOVES | [[#RELATIONSHIP MOVES\|Page 14]] |
> | COMBAT MOVES | [[#FATE MOVES\|Page 16]] |
> | SUFFER MOVES | [[#SUFFER MOVES\|Page 18]] |
> | DELVE MOVES | [[#DELVE MOVES\|Page 20]] |
> | FAILURE MOVES | [[#FAILURE MOVES\|Page 23]] |
> | THREAT MOVES | [[#THREAT MOVES\|Page 24]] |
> | RARITY MOVES | [[#RARITY MOVES\|Page 25]] |
^TOC
...
| --- | --- | --- |
| _Advance_ | Quest | 12 / _Ironsworn_ 103 |
| _Advance a Threat_ | Threat | 24 / _Delve_ 154–157 |
| _Aid Your Ally_ | Relationship | 14 / _Ironsworn_ 76–77 |
| _Ask the Oracle_ | Fate | 13 / _Ironsworn_ 107–109 |
| _Battle_ | Combat | 17 / _Ironsworn_ 84–85 |
| _Begin the Scene_ | Scene | Challenge 11 / _Ironsworn_ 234–235 |
| _Check Your Gear_ | Adventure | 9 / _Delve_ 38–39 |
| _Clash_ | Combat | 16 / _Ironsworn_ 80 |
| _Companion Endure Harm_ | Suffer | 18 / _Ironsworn_ 94 |
| _Compel_ | Relationship | 14 / _Ironsworn_ 69–70 |
| _Delve_ the Depths_ | _Delve_ | 20 / _Delve_ 21–29 |
| _Discover a Site_ | _Delve_ | 20 / _Delve_ 4–20 |
| _Draw the Circle_ | Relationship | 15 / _Ironsworn_ 73 |
| _End the Fight*_ | Combat | 17 / _Ironsworn_ 82–83 |
| _Endure Harm_ | Suffer | 18 / _Ironsworn_ 91–92 |
| _Endure Stress_ | Suffer | 19 / _Ironsworn_ 95–96 |
| _Enter the Fray_ | Combat | 16 / _Ironsworn_ 78–79 |
| _Escape the Depths_ | _Delve_ | 22 / _Delve_ 42–43 |
| _Face a Setback_ | Suffer | 19 / _Ironsworn_ 97 |
| _Face Danger_ | Adventure | 8 / _Ironsworn_ 60 |
| _Face Danger (SC Mode)_ | Scene Challenge | 11 / _Ironsworn_ 234–235 |
| _Face Death_ | Suffer | 18 / _Ironsworn_ 93 |
| _Face Desolation_ | Suffer | 19 / _Ironsworn_ 96 |
| _Find an Opportunity_ | _Delve_ | 21 / _Delve_ 30–33 |
| _Finish the Scene*_ | Scene Challenge | 11 / _Ironsworn_ 234–235 |
| _Forge a Bond_ | Relationship | 15 / _Ironsworn_ 74–75 |
| _Follow a Path_ | Journey | 10 / Bonus move |
| _Forsake Your Vow_ | Quest | 12 / _Ironsworn_ 102 |
| _Fulfill Your Vow*_ | Quest | 12 / _Ironsworn_ 101–102 |
| _Gain a Rarity_ | Rarity | 25 / _Delve_ 172–175 |
| _Gather Information_ | Adventure | 9 / _Ironsworn_ 62 |
| _Heal_ | Adventure | 9 / _Ironsworn_ 63 |
| _Learn From Your Failures*_ | Failure | 23 / _Delve_ 58–59 |
| _Locate Your Objective*_ | _Delve_ | 22 / _Delve_ 40–41 |
| _Make Camp_ | Adventure | 9 / _Ironsworn_ 64 |
| _Mark Your Failure_ | Failure | 23 / _Delve_ 58 |
| _Out of Supply_ | Suffer | 19 / _Ironsworn_ 97 |
| _Pay the Price_ | Fate | 13 / _Ironsworn_ 105–107 |
| _Reach a Milestone_ | Quest | 12 / _Ironsworn_ 100 |
| _Reach Your Destination*_ | Journey | 10 / _Ironsworn_ 68 |
| _Reveal a Danger_ | _Delve_ | 21 / _Delve_ 34–37 |
| _Resupply_ | Adventure | 9 / _Ironsworn_ 63–64 |
| _Secure an Advantage_ | Adventure | 8 / _Ironsworn_ 61 |
| _Secure an Advantage (SC Mode)_ | Scene Challenge | 11 / _Ironsworn_ 234–235 |
| _Sojourn_ | Relationship | 14 / _Ironsworn_ 71–72 |
| _Strike_ | Combat | 16 / _Ironsworn_ 79 |
| _Swear an Iron Vow_ | Quest | 12 / _Ironsworn_ 98–99 |
| _Take a Hiatus_ | Threat | 24 / _Delve_ 158 |
| _Test Your Bond_ | Relationship | 15 / _Ironsworn_ 75–76 |
| _Turn the Tide_ | Combat | 17 / _Ironsworn_ 81 |
| _Undertake a Journey_ | Journey | 10 / _Ironsworn_ 65–67 |
| _Wield a Rarity_ | Rarity | 25 / _Delve_ 176–179 |
| _Write Your Epilogue*_ | Relationship | 15 / _Ironsworn_ 77 |

*6 MOVES COMPENDIUM MOVES INDEX* - [[#^TOC|TOC]]
...
### PAYING THE PRICE
When you suffer a cost on a move, you usually see a prompt to **[[#PAY THE PRICE\|Pay the Price]]**. This is a special move that lets you pick a likely negative outcome, roll on a table to see what happens, or use some other random prompt.

A costly outcome can involve a narrative consequence that complicates things for your character, or a combination of a narrative and mechanical cost. Depending on the situation, a negative outcome might be framed as a result of an error or misstep, or as an external event you had no control over. Be mindful of pacing. Start with lesser consequences appropriate to the situation, and apply escalating danger and hardships if the failures stack up.

*7 MOVES COMPENDIUM MOVES INDEX* - [[#^TOC|TOC]]
...
- You are tired or hurt: **[[#ENDURE HARM\|Endure Harm]]** (1 harm).
...
> ___
> On a **strong hit**, take both.
> On a **weak hit**, choose one.
> - Take +2 momentum
> - Add +1 on your next move (not a progress move) 

*MOVES COMPENDIUM ADVENTURE MOVES 8* - [[#^TOC|TOC]]
...
On a **miss**, you don’t have it and the situation worsens. **[[#PAY THE PRICE\|Pay the Price]]**.

*9 MOVES COMPENDIUM ADVENTURE MOVES* - [[#^TOC|TOC]]
...
- You pressed on through pain, sickness, or weariness: **[[#ENDURE HARM\|Endure Harm]]**.
- You suffered under the burden of foul weather, worries, or fearful locations: **[[#ENDURE STRESS\|Endure Stress]]**.
- You wasted resources.
- You face a complication or hazard at the destination. Envision what you find (**[[#ASK THE ORACLE\|Ask the Oracle]]** if unsure).

On a **miss**, you are waylaid by a dire threat, and must **[[#PAY THE PRICE\|Pay the Price]]**. If you overcome this obstacle, you may push on safely to your destination.

> [8-point-star]
> *Follow a Path* is a bonus move for this guide. It is adapted from the *Set a Course* move in *Starforged*—which itself is adapted from the **[[#ESCAPE THE DEPTHS\|Escape the Depths]]** move in *Delve*.
> 
...
*10 MOVES COMPENDIUM JOURNEY MOVES* - [[#^TOC|TOC]]
...
Then, activate a four-segment countdown track and **[[#FACE DANGER\|Face Danger]]** or **[[#SECURE AN ADVANTAGE\|Secure an Advantage]]** to take action.
...
On a **miss**, you fail, or a momentary success is undermined by a dramatic turn of events. Mark a countdown segment and **[[#PAY THE PRICE\|Pay the Price]]**. On a miss with a match, mark two segments and **[[#PAY THE PRICE\|Pay the Price]]**.
...
On a **miss**, you fail or your assumptions betray you. Mark a countdown segment and **[[#PAY THE PRICE\|Pay the Price]]**. On a miss with a match, mark two segments and **[[#PAY THE PRICE\|Pay the Price]]**.
...
On a **miss**, you fail or are undermined by a dire turn of events. **[[#PAY THE PRICE\|Pay the Price]]**.

> [8-point-star]
> The scene challenge moves are adapted from *Starforged*.

*11 MOVES COMPENDIUM SCENE CHALLENGE MOVES* - [[#^TOC|TOC]]
...
### FORSAKE YOUR VOW
**When you renounce your quest, betray your promise, or the goal is lost to you**, clear the vow and **[[#ENDURE STRESS\|Endure Stress]]**. You suffer -spirit equal to the rank of your quest (troublesome=1; dangerous=2; formidable=3; extreme=4; epic=5).

If the vow was made to a person or community with whom you share a bond, **[[#TEST YOUR BOND\|Test Your Bond]]** when you next meet.
...
*12 MOVES COMPENDIUM QUEST MOVES* - [[#^TOC|TOC]]
...
| Roll | Price |
| :---: | --- |
| 1–2 | Roll again and apply that result but make it worse. If you roll this result yet again, think of something dreadful that changes the course of your quest (**[[#ASK THE ORACLE\|Ask the Oracle]]** if unsure). |
...
*13 MOVES COMPENDIUM FATE MOVES* - [[#^TOC|TOC]]
...
On a **strong hit**, you and your allies may each choose two from within the categories below. On a **weak hit**,
choose one. If you share a bond, choose one more.
...
On a **miss**, you find no help here. **[[#PAY THE PRICE\|Pay the Price]]**.

*14 MOVES COMPENDIUM RELATIONSHIP MOVES* - [[#^TOC|TOC]]
...
### DRAW THE CIRCLE
**When you challenge someone to a formal duel, or accept a challenge**, roll +heart. If you share a bond with
...
On a **miss**, you begin the duel at a disadvantage. Your foe has initiative. **[[#PAY THE PRICE\|Pay the Price]]**.
...
*15 MOVES COMPENDIUM RELATIONSHIP MOVES* - [[#^TOC|TOC]]
...
*16 MOVES COMPENDIUM COMBAT MOVES* - [[#^TOC|TOC]]
...
If you fail to score a hit on that move, you must suffer a dire outcome. **[[#PAY THE PRICE\|Pay the Price]]**.
...
For an alternate End the Fight with the flexibility of the Starforged move, replace the trigger with the following. This change, you may make the progress roll without a strong hit on a preceding move—but at greater risk of failure.

When you take decisive action to resolve the outcome of this fight, roll the challenge dice and compare to your progress. Momentum is ignored on this roll. If you do not have initiative, count a strong hit as a weak hit, and a weak hit as a miss.

*17 MOVES COMPENDIUM COMBAT MOVES* - [[#^TOC|TOC]]
...
- Death desires something of you in exchange for your life. Envision what it wants (**[[#ASK THE ORACLE\|Ask the Oracle]]** if unsure), and **[[#SWEAR AN IRON VOW\|Swear an Iron Vow]]** (formidable or extreme) to complete that quest. If you fail to score a hit when you Swear an Iron Vow, or refuse the quest, you are dead. Otherwise, you return to the mortal world and are now cursed. You may only clear the cursed debility by completing the quest.
...
*18 MOVES COMPENDIUM SUFFER MOVES* - [[#^TOC|TOC]]
...
*19 MOVES COMPENDIUM SUFFER MOVES* - [[#^TOC|TOC]]
...
On a **strong hit**, you delve deeper. Mark progress and **[[#FIND AN OPPORTUNITY\|Find an Opportunity]]**.
...
| 81–100 | 100 | 100 | Mark progress twice and **[[#REVEAL A DANGER\|Reveal a Danger]]**. |
...
*20 MOVES COMPENDIUM DELVE MOVES* - [[#^TOC|TOC]]
...
Use the standard **[[#REVEAL A DANGER\|Reveal a Danger]]** result when exploring a site with a theme and domain. Otherwise, use  the alternate roll.

*21 MOVES COMPENDIUM DELVE MOVES* - [[#^TOC|TOC]]

### LOCATE YOUR OBJECTIVE
**When your exploration of a site comes to an end**, roll the challenge dice and compare to your progress.
...
*22 MOVES COMPENDIUM DELVE MOVES* - [[#^TOC|TOC]]
...
*23 MOVES COMPENDIUM FAILURE MOVES* - [[#^TOC|TOC]]
...
> 
> #### ADVANCING A THREAT
> As you encounter setbacks or delays, make the **[[#ADVANCE A THREAT\|Advance a Threat]]** move. If you must mark menace, fill the next available box in the menace track (the small inset boxes on the vow progress track).
> 
> #### RESOLVING A THREAT
> **If the threat succeeds…**
> When you mark the tenth box in a threat’s menace track, the threat achieves its goal. You must **[[#FORSAKE YOUR VOW|Forsake Your Vow]]** for the associated quest.
> 
> **If you [[#FULFILL YOUR VOW|Fulfill Your Vow]]…**
...
> 
> **If you [[#FORSAKE YOUR VOW|Forsake Your Vow]]…**
...
*24 MOVES COMPENDIUM THREAT MOVES* - [[#^TOC|TOC]]
...
> #### WONDROUS OBJECTS FOR YOUR IRONSWORN CAMPAIGN
...
> 
> When you claim the rarity, make the **[[#GAIN A RARITY\|Gain a Rarity]]** move to link it to a single existing asset. That asset is now augmented.
> 
...
> 
> #### USING A RARITY
> When you make an action roll using or supported by an augmented asset, roll a special D6 in place of your action die. This is your rarity die. Check the **[[#WIELD A RARITY\|Wield a Rarity]]** move to see if the rarity bolsters the  outcome.

*25 MOVES COMPENDIUM RARITY MOVES* - [[#^TOC|TOC]]