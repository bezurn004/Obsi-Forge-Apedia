...
> [8-point-star]
> *Follow a Path* is a bonus move for this guide. It is adapted from the *Set a Course* move in *Starforged*—which itself is adapted from the *Escape the Depths* move in *Delve*.
> 
...
If you are making this move as a result of a strong hit on **[[#DELVE THE DEPTHS|Delve the Depths]]**, you may pick or envision an opportunity instead of rolling. Then, choose one.
...
Use the standard *Reveal a Danger* result when exploring a site with a theme and domain. Otherwise, use  he alternate roll.
