---
Alias: "Undertake an Expedition (move)"
PageType: Move
...
## Expedition Perils
If you encounter a peril on an expedition because of a weak hit or miss, consider the nature of the danger as appropriate to the current situation. If you need inspiration, [[MV_Ask the Oracle|Ask the Oracle]]. You’ll find oracles to help inspire perils for various location types, including [[OCL_Spaceborne Peril|Space]], [[OCL_Planet_Peril|Planets]], [[_OCL_Derelicts|Derelict Perils]], and [[_OCL_PrecursorVaults|Precursor Vault Perils]]. Abstract oracles such as [[OCL_Core#Action and Theme|Action and Theme]]  can also spark ideas for a perilous situation.
