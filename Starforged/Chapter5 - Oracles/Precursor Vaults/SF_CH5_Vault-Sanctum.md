...
## Page
aliases:
  - "Vault Sanctum (SF Oracles)"
  - "Vault Purpose (SF Oracles)"
  - "Vault Sanctum - Feature (SF Oracles)"
  - "Vault Sanctum - Peril (SF Oracles)"
  - "Vault Sanctum - Opportunity (SF Oracles)"
PageType: Oracle
...
|:--- |:---:| ---:|
| **[[SF_CH5_Vault-Interior\|Precursor Vault Interior (SF Oracles)]]** | #Starforged/Oracles/PrecursorVaults | **[[_SF_CH5_LocationThemes\|Location Theme (SF Oracles)]]** |
