...
## Oracle: Creature Environment
 > [!mechanics]- | Roll > `dice: [[OT_ISSF_Creatures#^Location]]` | Guidance
> Choose the closest match for your location. Or roll to identify the primary habitat of a creature. ^guidance-Environment
...
> [!mechanics]- | Roll > `dice: [[OT_ISSF_Creatures#^Scale]]` | Guidance
> The general size of the creature ^guidance-OcllCreature-Scale
...
> [!mechanics]- | Roll > `dice: [[OT_ISSF_Creatures#^Ultra-Scale]]` | Guidance
