...
## Page
aliases:
  - "Creature Approach (SF Oracles)"
  - "Creature First Look (SF Oracles)"
  - "Creature Encountered Behavior (SF Oracles)"
  - "Creature Revealed Aspect (SF Oracles)"
PageType: Oracle
...
> [!mechanics]- | Roll > <br>▶1 `dice: [[OT_ISSF_Creatures#^First-Look]]`<br>▶2 `dice: [[OT_ISSF_Creatures#^First-Look]]` | Guidance
> Roll for a [[SF_CH5_Creature-Basic Form|Basic Form]], and flesh out the creature’s appearance with this oracle. ^guidance-OcllCreature-First-Look
...
> [!mechanics]- | Roll > `dice: [[OT_ISSF_Creatures#^Encountered-Behavior]]` | Guidance
> Roll once on this oracle to define this creature’s motivation and frame how the encounter begins. ^guidance-OcllCreature-Encountered-Behavior
...
|:--- |:---:| ---:|
| **[[SF_CH5_Creature-Basic Form\|Creature Basic Form (SF Oracles)]]** | #Starforged/Oracles/Creatures | **[[_SF_CH5_Factions\|Factions (SF Oracles)]]** |
