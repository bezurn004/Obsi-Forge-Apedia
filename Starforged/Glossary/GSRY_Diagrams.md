...
| Locations | _ **Name** _ | _ **Type** _ | _ **Blurb** _ |
| ---: | --- | ---: | --- |
| Location: | Bleakhold | Settlement (orbital)  | **Pop:** Hundreds<br>**Auth:** Corrupt<br>**Projects:** Mining, Black Market |
^diagram-sector-creation-1

| Locations | _ **Name** _ | _ **Type** _ | _ **Blurb** _ |
| ---: | --- | ---: | --- |
| Location: | Bleakhold | Settlement (orbital)  | **Pop:** Hundreds<br>**Auth:** Corrupt<br>**Projects:** Mining, Black Market<br><br><br>Ember (Furnace World)<br><br><br>**Star:** White dwarf |
...
| Locations | _ **Name** _ | _ **Type** _ | _ **Blurb** _ |
| ---:| --- | ---:| --- |
| Location: | Bleakhold | Settlement (orbital) | **Pop:** Hundreds<br>**Auth:** Corrupt<br>**Projects:** Mining, Black Market, Repurposed derelict<br><br>Ember (Furnace World)<br>**Atmo:** Toxic **Life:** Extinct<br>Magma seas, supervolcano, <br>Precursor vault, ash clouds<br><br>**Star:** White dwarf | 
