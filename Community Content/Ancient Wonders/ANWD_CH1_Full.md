#missingArt Cover page goes here

Markos Marafelias - Samuel Rondón Acevedo - Nando Gallarday
...
### CARDS ICON DESIGNER AND ADDITIONAL WRITING
Samuel Emilio Castillo

Copyright ©2024 Ludic Pen
This work is based on Ironsworn and Ironsworn:Starforged, created by Shawn Tomkin, and licensed for our use under the Creative Commons Attribution 4.0 International License.
www.ludicpen.com
@LudicPen

### PLEDGERS
Adam, Adam Remington, Alessandro Porri, Andrew Chandler, Andrew Mazibrada, Andrew Medeiros, Ben Long, Ben Williams,Benjamin Gagné, Bobby Bjfef0721, Brandon Mathis, Bryan Brake, Carlos Clavero, Caroline Owens, Chamomile Floyd, Chloé Dulieu, Chris Wegrzyn, Christina Hatziemmanuel, Christopher Smith, Dain, Dave Hogg, Denis Dodson, Denise C., Drzachary, Egbs402, Eitan Rosa, Elodie Grondin, Emily Gabriel, Erizocosmico, Euan Urquhart, Francisco Acosta, Gtds10hx, Harald Hofer, Head Cleric of Crom, Heebyjeebs, Hellesfarne, Ian Carr, John Bindas, Justin Renfroe, Kiel Strang, LacksForFinish, Maxime Dhoury, Mario Roberge-Reyes, Mark Brady, Matthijs Hellinghuizen, Mike Westely, Nicolas Taylor, Olav Müller, Oscar Axlesson, Paul Jones,Paul Seagrave, Philip Germeyer, RandomBurstofPanic, RJ, Sara Marie Morris, Selina, Sen Arcturus, Shasjas, Sn3akiwhizper,Solanaar, Stephen Brown, Sterling Brucks, Suzanne Mouzaffar, Sérgio J. Sousa, Thomas Spofford, Tomas Chavarria, Travis Porter, Waterbane, Will Cotton, Zethican

### ACKNOWLEDGMENTS
***Ancient Wonders*** takes its inspiration for the planets, megastructures, and megacities from ***Gigastructural Engineering & More***, by TTFTCUTS et al., ***Planetary Diversity***, by Frai7ty et al. (Stellaris Mods), and ***Megastructures: A Visual Encyclopedia***, by Neil Blevins.

### SPECIAL THANKS
**Angela Aelis, Daniel Mullan, Peter Jones** for playtesting the Solar System Generation guidelines, and **Philip Pryce** for creating a software tool that assisted in its design.

**Ben Williams**, for always being receptive to our proof copies and providing photography.

**Carolina Lazzaro**, for helping develop the Ceramic oracle and being the unconditional emotional support to our general director.

**Fernando Adrián Campos**, for assisting in the illustration of the movable and underground megacities.

**Roselle Accardo**, for being a sounding board for ideas and the emotional pillar to Markos Marafelias.

**Sofía Peralta**, for assisting in the design of the ==Hunker Down== move.

**Vincent Van Gato**, for being the Ludic Pen mascot and the emotional support—alongside **Alexandra Gallarday**, **Carlos Delgado**, and **Julio Montes**—to Nando Gallarday, our beloved art director.

### IN SPECIAL DEDICATION TO...
**Eunice Millán Zabala**, whose resilience in her fight against cancer is a marvel and whose brightness illuminates the darkest of times. Without her spousal support, Ludic Pen would not exist.

You are my most favorite wonder. The best my galaxy had to offer.
...
> |  |  |
> | --- | :---: |
> | THE WONDROUS SIDE OF THE GALAXY | [[#THE WONDROUS SIDE OF THE GALAXY\|Page 8]] |
> | MARVELS OF FOREGONE AGES | [[#MARVELS OF FOREGONE AGES\|Page 9]] |
> | USING THIS BOOK | [[#USING THIS BOOK\|Page 10]] |
> | SYSTEM-AGNOSTIC USAGE | [[#SYSTEM-AGNOSTIC USAGESYSTEM-AGNOSTIC USAGE\|Page 11]] |
...
Throughout the supplement, you will be presented with a plethora of random tables to enhance your experience in the science fiction game of your preference. Ancient Wonders offers...
* A realistic ==solar system generator== for planetary and asteroid composition. This sub-system provides more richness in exploration and a more concisely focused narrative experience; you won’t have adventures throughout multiple small sectors but rather in entire solar systems.
...
* ==Megastructures== to discover, with a set of oracles and a sub-system for undertaking extensive expeditions in the alien, unfathomable depths of these marvels. These wonders come with default assumptions, truths, and unique mechanics for implementation in your campaign.
* ==Megacities== to explore, with a set of oracles and a sub-system for researching the alien societies that once inhabited them as well as default assumptions and truths for their inclusion in your campaign.
* ==Constructs==, ==bio-mechanics==, and ==anomaly generators== for new types of encounters in alien and hazardous sites.
...
## MEGASTRUCTURES
Megastructures are incredible constructions built by long-extinct alien species. These feats of engineering are rare showcases of their civilizations' capabilities and are where some of the products of their technology—and the phenomena that derived from it—can be seen.

## MEGACITIES
Megacities are the ruins of settlements that belonged to long-gone civilizations. These places still hold many mysteries and continue to be haunted by shadows of the past, though that doesn't stop humanity from taking possession of them.

## CONSTRUCTS
Constructs are synthetic beings. The ones designed by foregone species are listed among the only yesteryear’s marvels that are truly conscious of their existence, and they protect the megastructures as zealous guardians.
...
You don’t need to read Ancient Wonders from front to back toimplement it into your game. As a modular supplement, you takewhat fits your interests. Here is a summary of each chapter andsome advice on how to read them.
...
# SYSTEM-AGNOSTIC USAGESYSTEM-AGNOSTIC USAGE
...
### ASK THE ORACLE
Throughout this material, you will see prompts to [[SF_CH3_Ask the Oracle|Ask the Oracle]]. This is a ***Starforged*** move to generate answers to close-ended questions about the outcome of an action, an aspect of your setting, or a narrative event.
...
> On a match on your oracle dice, envision an extreme result, a twist, or narrative surprise.

## ORACLES
***Ancient Wonders*** is filled with random tables, referred to as oracles. To use these oracles, you need what is referred to as ==oracle dice==—a percentile die (1d100 or 2d10).

The core oracles are presented on the next page. Some oracles refer to other oracles that are spread out in different chapters of this book or in other materials mentioned in the previous heading. If you encounter one that prompts you to use content that you don’t wish to include in your game—or if you don’t like a particular random table result—change that result or adjust it. You may…

- Check up or down one row from your original result
- Reverse the digits
- Roll again
- Fall back to your instincts and decide on an answer

Some oracles provide a recommended number of rolls. This is indicated with a loop icon: @. Another note is that oracle results often prompt the use of another oracle. This is shown as a greater-than symbol (>) with the name(s) of the oracle.

### CURSED TABLES
Some tables in this book are marked with a triangle icon: [tri-skull]. These are the cursed tables. The rules for using cursed dice and tables are summarized in ***Sundered Isles*** as follows:

> *When you use one of those tables for inspiration, you may roll a cursed die alongside your oracle dice. The cursed die is also ten-sided, but should be a special color or material to distinguish it from the oracle dice.*
>
...
|  |  |  |  |  |  |  |  |  |  |
| :---: | --- | :---: | --- | :---: | --- | :---: | --- | :---: | --- |
| 1 | AI | 21 | Data | 41 | Home | 61 | Portal | 81 | Station |
| 2 | Alarm | 22 | Debris | 42 | Illusion | 62 | Probe | 82 | Storage |
| 3 | Anomaly | 23 | Device | 43 | Industry | 63 | Reality | 83 | Storm |
| 4 | Apparition | 24 | Dimension | 44 | Lair | 64 | Recording | 84 | Structure |
| 5 | Archive | 25 | Ecosystem | 45 | Lifeform | 65 | Refuge | 85 | Supply |
| 6 | Art | 26 | Enclosure | 46 | Liquid | 66 | Relic | 86 | Symbol |
| 7 | Artifact | 27 | Energy | 47 | Machine | 67 | Remains | 87 | System |
| 8 | Atmosphere | 28 | Environment | 48 | Material | 68 | Rendezvous | 88 | Technology |
| 9 | Battleground | 29 | Equipment | 49 | Mechanism | 69 | Resource | 89 | Terrain |
| 10 | Beacon | 30 | Facility | 50 | Message | 70 | Route | 90 | Territory |
| 11 | Being | 31 | Fleet | 51 | Mineral | 71 | Ruins | 91 | Transportation |
| 12 | Blockade | 32 | Force | 52 | Monument | 72 | Salvage | 92 | Trap |
| 13 | Boundary | 33 | Fortification | 53 | Network | 73 | Sector | 93 | Treasure |
| 14 | Cache | 34 | Fuel | 54 | Obstacle | 74 | Settlement | 94 | Vault |
| 15 | Cargo | 35 | Gas | 55 | Orbit | 75 | Shelter | 95 | Vehicle |
| 16 | Commodity | 36 | Grave | 56 | Organism | 76 | Shortcut | 96 | Viewpoint |
| 17 | Confinement | 37 | Gravity | 57 | Path | 77 | Signal | 97 | Void |
| 18 | Container | 38 | Habitat | 58 | People | 78 | Sound | 98 | Weapon |
