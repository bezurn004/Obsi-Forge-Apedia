...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Factions#^Relationships]]` | Guidance
> When you have a question about the relationship of one faction to another, use this table. The result is the commonly understood connection between those factions. Further investigations or events may reveal a deeper or alternate truth. ^guidance-Relationship
...
| 45 - 47 | Negotiating with | Has influence in the same sector as | Held in contempt by |
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Factions#^Rumors]]` | Guidance
...
| 43 - 45 | Leaders are haunted by a dark prophecy | Key agent is interested in flipping sides | Inadvertently causing a calamity or disaster |
...
| :--- | :---: | ---: |
| **[[STRSM_OCL_Faction-Motives\|Faction Motives (STRSM Oracles)]]** | #Starsmith/Oracles/Factions | **[[_STRSM_OCL_Derelict Oracles\|Derelict (STRSM Oracles)]]** |
