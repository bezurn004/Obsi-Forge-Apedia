...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Factions^Type]]` | Guidance
> The Type tells you the general type of organization it is. After you know their type, you then roll on the corresponding oracles. Note that for the Dominion type, you roll on both the Dominion and Leadership oracles, although I use the Leadership oracle for all factions.^guidance-Type

| 1d100 | Result (1-2) |
| :---: | --- |
| 1 - 40 |  [[STRSM_OCL_Faction-Types#Oracle Faction Type - Dominion\| ▶Dominion]]<br>Governing power | [[STRSM_OCL_Faction-Types#Oracle Faction Type - Corporation Field\| ▶Corporation]]<br>Influential business that rules economically | [[STRSM_OCL_Faction-Types#Oracle Faction Type - Research Field of Study\| ▶Research Group]]<br>Wealthy scientists developing influence |
| 41 - 70 |  [[STRSM_OCL_Faction-Types#Oracle Faction Type - Guild\| ▶Guild]]<br>Organization of specialists | [[STRSM_OCL_Faction-Types#Oracle Faction Type - Military Specialty\| ▶Military]]<br>Military outfit exerting power | [[STRSM_OCL_Faction-Types#Oracle Faction Type - Data Harvesters Role\| ▶Data Harvesters]]<br>Keepers of knowledge |
| 71 - 100 |  [[STRSM_OCL_Faction-Types#Oracle Faction Type - Fringe Group\| ▶Fringe Group]]<br>Band of outlaws, outcasts, or rogues |[[STRSM_OCL_Faction-Types#Oracle Faction Type - Religious Role\| ▶Religious]]<br>Sect of mainline believers | [[STRSM_OCL_Faction-Types#Oracle Faction Type - AI Hive Prime Directive\| ▶AI Hive]]<br>Independent, self-governing AI |
^table-Type
...
> [!mechanics]- | Roll ▶1 `dice: [[OT_STRSM_OCL_Factions#^Type-Dominion]]` ▶2 `dice: [[OT_STRSM_OCL_Factions#^Type-Dominion]]` ▶3 `dice: [[OT_STRSM_OCL_Factions#^Type-Dominion]]` | Guidance
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Factions#^Type-Guild]]` | Guidance
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Factions#^Type-Fringe-Group]]` | Guidance
...
| 61 - 70 | Rebels | Planet pillagers | Population controllers |
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Factions#^Type-Corporation]]` | Guidance
> The primary revenue source for this Corporation faction. ^guidance-Type-Corporation-Field
...
| 97 - 100 | Roll twice |
^table-Type-Corporation-Field

### Oracle: Faction Type - Military Specialty
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Factions#^Type-Military-Specialty]]` | Guidance
> How this Military faction generate revenue and influence. ^guidance-Type-Military-Specialty
...
| 97 - 100 | Roll twice |
^table-Type-Military-Specialty

### Oracle: Faction Type - Religious Role
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Factions#^Type-Religious-Role]]` | Guidance
> Primal factor that unites this Religious faction's most devout. ^guidance-Type-Religious-Role
...
| 97 - 100 | Roll twice |
^table-Type-Religious-Role

### Oracle: Faction Type - Research Field of Study
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Factions#^Type-Research-Field-Of-Study]]` | Guidance
> The primary field of focus for this Research faction. ^guidance-Type-Research-Field-of-Study
...
| 94 - 95 | Xenozoology |
| 96 - 100 | Roll twice |
^table-Type-Research-Field-of-Study

### Oracle: Faction Type - Data Harvesters Role
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Factions#^Type-Data-Harvesters-Role]]` | Guidance
> Information of keen interest for this Data Harvesters faction. ^guidance-Type-Data-Harvesters-Role
...
| 97 - 100 | Roll twice |
^table-Type-Data-Harvesters-Role

### Oracle: Faction Type - AI Hive Prime Directive
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Factions#^Type-AI-Hive]]` | Guidance
> Fundamental program to which this AI Hive faction adheres. ^guidance-Type-AI-Hive-Prime-Directive
...
| 97 - 100 | Roll twice |
^table-Type-AI-Hive-Prime-Directive

## Tags
| Section Page | Tags | Next Page | 
| :--- | :---: | ---: |
| **[[_STRSM_OCL_Factions Oracles\|Faction (STRSM Oracles)]]** | #Starsmith/Oracles/Factions | **[[STRSM_OCL_Faction-Names\|Faction Name (STRSM Oracles)]]** |
