...
---
# [[_STRSM Oracles Index|Starsmith Oracles]]: Planets
...
>![[#Planetary Class]]
> 
> ### [[STRSM_OCL_Planetside-Fortune\|Planetside Fortune]]
...
## Planetary Class
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Planets#^Class]]`<br>▶[[OT_STRSM_OCL_Core#Descriptor\|D]] `dice: [[OT_STRSM_OCL_Core#^Descriptor]]` + ▶[[OT_STRSM_OCL_Core#Focus\|F]] `dice: [[OT_STRSM_OCL_Core#^Focus]]` | Guidance
> When you encounter a planet, roll on these oracles to find out more about it. Start with the Planetary Class oracle below, and then move on to the oracles of that specific planet class. ^guidance-Planetary-Class
...
| :--- | :---: | ---: |
| **[[_STRSM_OCL_Space Encounter Oracles\|Space Encounter (STRSM Oracles)]]** | #Starsmith/Oracles/Planets  | **[[_STRSM_OCL_Settlement Oracles\|Settlement (STRSM Oracles)]]** |
