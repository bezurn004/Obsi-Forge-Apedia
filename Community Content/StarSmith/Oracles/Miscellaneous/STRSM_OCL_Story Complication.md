...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Misc#^Story-Complication]]` | Guidance
> This oracle will introduce narrative turns, troubles, and revelations. It can be used as an alternative to the [[SF_CH3_Pay the Price|Pay the Price]] table when you encounter a negative outcome at a crucial moment. In particular, you might use this oracle after rolling matched 10s on the challenge dice.^guidance-Story-Complication
...
| :--- | :---: | ---: |
| **[[_STRSM_OCL_Misc Oracles\|Miscellaneous (STRSM Oracles)]]** | #Starsmith/Oracles | **[[STRSM_OCL_Story Clue\|Story Clue (STRSM Oracles)]]** |
