...
> [!mechanics]- | Roll ><br>▶1 `dice: [[OT_STRSM_OCL_Creatures#^First-Look]]`<br>▶2 `dice: [[OT_STRSM_OCL_Creatures#^First-Look]]` | Guidance
> Roll for a [[SF_CH5_Creature-Basic Form|Basic Form]], and flesh out the creature’s appearance with this oracle. The thing you first notice. This could be a physical feature or other descriptive term like “Graceful” for its movements. ^guidance-First-Look
...
| 27 - 28 | Distinctive markings | Extremely wide | Filthy |
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Creatures#^Encountered-Behavior]]` | Guidance
> Roll once on this oracle to define this creature’s motivation and frame how the encounter begins. This is the way the creature has behaved in your presence. Remember that this could be abnormal behavior since it may not have encountered humans before. ^guidance-Encountered-Behavior
...
| 65 - 66 | Metamorphic | Pinning attack | Plant control |
...
| :--- | :---: | ---: |
| **[[_STRSM_OCL_Creature Oracles\|Creature (STRSM Oracles)]]** | #Starsmith/Oracles/Creatures | **[[_STRSM_OCL_Factions Oracles\|Faction (STRSM Oracles)]]** |
