...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Vaults#^Interior-First-Look]]` | Guidance
> Use this oracle to reveal what you see or encounter when first entering the site. These aspects, combined with the exterior features, will help you envision the nature and condition of the vault and provide context for the rest of your exploration. ^guidance-Interior-First-Look
...
| 37 - 39 | Excessive cold | Evidence of a skirmish or battle | Inter-dimensional folding of space |
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Vaults#^Interior-Feature]]` | Guidance
> To flesh out this Precursor Vault, choose or roll on an aspect observed from the interior. ^guidance-Interior-Feature
...
| 26 - 28 | Enigmatic controls or terminal | Hallway of doors | Flashing emergency lights |
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Vaults#^Interior-Peril]]` | Guidance
> Choose or roll for a peril when narratively appropriate or rolling a miss with a match on the challenge dice when making the [[SF_CH3_Undertake an Expedition|Undertake an Expedition (move)]]. ^guidance-Interior-Peril

| 1d100 | 1-2 | 3-4 | 5-6 |
| :---: | --- | --- | --- |
| 1 - 5 | Broken path | Betrayed by false sensor readings | Adhesive or difficult terrain |
| 6 - 10 | Change in atmosphere or environment | Blinding or overwhelming lights | Automated defense system activated |
| 11 - 15 | Corrosive environment | Blocked path | Crippling waves of emotion |
| 16 - 20 | Dire warning left by other explorers | Dangerous lifeform nesting | Critical overload imminent |
| 21 - 25 | Foes close in | Electrified environment | Crucial gear must be jury rigged |
| 26 - 30 | Fragile structural integrity | Emergency protocols activated | Floor gives way |
| 31 - 35 | Hazardous path designed for traversal by other beings | Environmental hazard containment systems failure | Foes join forces |
| 36 - 40 | Important gear malfunctions | Explosive decompression or venting | Ghost in the machine |
| 41 - 45 | Isolation or fear presses in | Lack of atmosphere | Grim scenes weigh you down |
| 46 - 50 | Mechanical trap | Malfunctioning maintenance bots | Hallucinations test your perception of reality |
| 51 - 55 | Mist or darkness conceals dangers | Movement in the shadows | It was a red herring |
| 56 - 60 | Puzzling mystery blocks the way | New foe appears | Lockdown initiated |
| 61 - 65 | Radioactive hot spot | Past comes back to haunt you | Magnetic environment |
| 66 - 70 | Rivals seek what lay within | Protective suit or environment breach | Opportunity is lost |
| 71 - 75 | Signs of a contagion | Rivals hold a secret from within | Precarious path |
| 76 - 80 | Signs of a lurking foe | Security system blocks the way | Rivals damaged what lay within |
| 81 - 85 | Tempting location or object holds hidden dangers | Shifts in gravity | Runaway AI opposes you |
| 86 - 90 | Toxic atmosphere | Structural collapse pins important object | Stellar activity interferes with equipment |
| 91 - 95 | Unnerving sound or sensation | Valuable data being erased or degraded | Sterilizing agents released |
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Vaults#^Interior-Opportunity]]` | Guidance
> Choose or roll for an opportunity after scoring a strong hit when you [[SF_CH3_Explore a Waypoint|Explore a Waypoint (move)]]. ^guidance-Interior-Opportunity

| 1d100 | 1-2 | 3-4 | 5-6 |
| :---: | --- | --- | --- |
| 1 - 10 | Clue points the way to your destination or target | Clue connecting two threads | Access to data obtained or granted |
| 11 - 20 | Clue to a lifeform’s nature or vulnerabilities | Clue to a master plan | Clue to a rival's weakness |
| 21 - 30 | Helpful gear left by another explorer | Encouraging message or log | Clue to bypassing defensive systems |
| 31 - 40 | Insight into the nature or history of this site | Friendly or helpful AI | Insight into previous intruders |
| 41 - 50 | Intriguing device or artifact | Helpful message left by another explorer | Intriguing augmentation or module for gear |
| 51 - 60 | Opening to get the drop on a foe | Insight into the creators of this site | Opening to drive a wedge between foes |
| 61 - 70 | Opening to outmaneuver or escape a threat or foe | Intriguing data or notes | Opening to eliminate a foe |
| 71 - 80 | Salvageable resource | Opening to parlay with a foe or rival | Sight or experience inspires awe |
| 81 - 90 | Secure area offers a moment of peace | Opening to trap a foe | Unexpected ally appears |
| 91 - 100 | Shortcut or less perilous path speeds your way | Portable power supply | Usable computer interface |
^table-Interior-Opportunity

## Tags
| Previous Page | Tags | Next Page | 
| :--- | :---: | ---: |
| **[[STRSM_OCL_Vault-Creation\|Precursor Vault Creation (STRSM Oracles)]]** | #Starsmith/Oracles/PrecursorVaults | **[[STRSM_OCL_Vault-Sanctum\|Precursor Vault Scantum (STRSM Oracles)]]** |
