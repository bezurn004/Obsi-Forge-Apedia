...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Vaults#^Purpose]]` | Guidance
...
| 25 - 27 | Containment of weapons | Containment of dangerous stellar phenomenon | Establishing settlements |
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Vaults#^Sanctum-Feature]]` | Guidance
> Once your exploration of an enigmatic precursor vault enters the sanctum, choose or roll on these oracles as your expedition reveals the final aspects of the precursor vault that enhances its nature. ^guidance-Sanctum-Feature
...
| 35 - 37 | Machinery fused with organic growths | Inter-dimensional echoes | Floating spaces tethered by energy |
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Vaults#^Sanctum-Peril]]` | Guidance
> When exploring the sanctum, choose or roll for a peril after rolling a match on the challenge dice with a miss for the [[SF_CH3_Undertake an Expedition|Undertake an Expedition (move)]]. ^guidance-Sanctum-Peril
...
| 41 - 45 | Other intruders have been corrupted or mutated by this place | Environment hostile to organic life | Immobilized by unnatural forces  |
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Vaults#^Sanctum-Opportunity]]` | Guidance
> When exploring the sanctum, choose or roll for an opportunity after scoring a strong hit when you [[SF_CH3_Explore a Waypoint|Explore a Waypoint (move)]]. ^guidance-Sanctum-Opportunity
...
^table-Sanctum-Opportunity

## Tags
| Previous Page | Tags | Next Section | 
| :--- | :---: | ---: |
| **[[STRSM_OCL_Vault-Interior\|Precursor Vault Interior (STRSM Oracles)]]** | #Starsmith/Oracles/PrecursorVaults | **[[_STRSM_OCL_LocationTheme Oracles\|Location / Theme (STRSM Oracles)]]** |
