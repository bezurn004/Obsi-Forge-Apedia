...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Vaults#^Material]]` | Guidance
...
| 89 - 90 | Liquid | Gaseous | Packed ice |
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Vaults#^Outer-First-Look]]` | Guidance
...
| 93 - 95 | Surrounded by destruction | Teleporting to new locations | Warning signs left by previous explorers |
...
| :--- | :---: | ---: |
| **[[_STRSM_OCL_PrecursorVaults Oracles\|Precursor Vault (STRSM Oracles)]]** | #Starsmith/Oracles/PrecursorVaults | **[[STRSM_OCL_Vault-Interior\|Precursor Vault Interior (STRSM Oracles)]]** |
