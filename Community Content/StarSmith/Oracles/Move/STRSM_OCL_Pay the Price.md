...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Moves^Pay-The-Price]]` | Guidance
> When you suffer the outcome of an action and choose to roll on the table below. If the result doesn’t fit the situation, roll again. ^guidance-Pay-the-Price
...
| :--- | :---: | ---: |
| **[[STRSM_OCL_Make a Discovery\|Make a Discovery (STRSM Oracles)]]** | #Starsmith/Oracles/Moves | **[[_STRSM_OCL_Oracle Templates\|Oracle Templates (STRSM Oracles)]]** |
