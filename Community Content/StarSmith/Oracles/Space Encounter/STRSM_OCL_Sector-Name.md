...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Space#^Sector-Name-Prefix]]` | Guidance
> To generate a name for a sector or region of space, roll once for the prefix (the first word), and once for the suffix (the second word). Or just roll once, and choose a suitable prefix and suffix from anywhere in that row. ^guidance-Sector-Name-Prefix
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Space#^Sector-Name-Suffix]]` | Guidance
> To generate a name for a sector or region of space, roll once for the prefix (the first word), and once for the suffix (the second word). Or just roll once, and choose a suitable prefix and suffix from anywhere in that row. ^guidance-Sector-Name-Suffix
...
^table-Sector-Name-Suffix

## Tags
| Previous Page | Tags | Next Page | 
| :--- | :---: | ---: |
| **[[STRSM_OCL_Space-Sightings\|Space SIghtings (STRSM Oracles)]]** | #Starsmith/Oracles/Space | **[[STRSM_OCL_Stellar-Object\|Stellar Object (STRSM Oracles)]]** |
