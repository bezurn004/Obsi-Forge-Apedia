...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Characters^Role]]` | Guidance
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Characters^Goal]]` | Guidance
...
> [!mechanics]- | Roll ><br>▶1 `dice: [[OT_STRSM_OCL_Characters^Revealed-Aspect]]`<br>▶2 `dice: [[OT_STRSM_OCL_Characters^Revealed-Aspect]]` <br>▶3 `dice: [[OT_STRSM_OCL_Characters^Revealed-Aspect]]` | Guidance
...
| :--- | :---: | ---: |
| **[[STRSM_OCL_Character-Approach\|Character Approach (STRSM Oracles)]]** | #Starsmith/Oracles/Characters | **[[STRSM_OCL_Character-Names\|Character Name (STRSM Oracles)]]** |
