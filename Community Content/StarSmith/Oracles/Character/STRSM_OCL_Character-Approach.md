...
Use the Character **[[STRSM_OCL_Character-Approach#Oracle Character First Look|First Look]]** and **[[STRSM_OCL_Character-Approach#Oracle Character Initial Disposition|Initial Disposition]]** oracles to get the first impression of an NPC when they first meet your character.
...
> [!mechanics]- | Roll ><br>▶1 `dice: [[OT_STRSM_OCL_Characters^First-Look]]`<br>▶2 `dice: [[OT_STRSM_OCL_Characters^First-Look]]` | Guidance
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Characters^Initial-Disposition]]` | Guidance
> Their attitude towards you, at least at first. I’m sure they’ll love you once they really get to know you. You didn’t really mean for that engine core to go critical with their family on board, did you? Nah… ^guidance-Initial-Disposition
...
^table-Initial-Disposition

## Tags
| Previous Page | Tags | Next Page | 
| :--- | :---: | ---: |
| **[[_STRSM_OCL_Character Oracles\|Character (STRSM Oracles)]]** | #Starsmith/Oracles/Characters | **[[STRSM_OCL_Character-Drives\|Character Drives (STRSM Oracles)]]** |
