...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Districts^Medical-Area]]` | Guidance
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Districts^Medical-Feature]]` | Guidance
...
^table-Medical-Feature

## Oracle: District Zone Medical: Peril
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Districts^Medical-Peril]]` | Guidance
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Districts^Medical-Opportunity]]` | Guidance
...
^table-Medical-Opportunity

## Tags
| Previous Page | Tags | Next Page | 
| :--- | :---: | ---: |
| **[[STRSM_OCL_District-Zone-Living\|District Zone: Living (STRSM Oracles)]]** | #Starsmith/Oracles/Districts | **[[STRSM_OCL_District-Zone-Operations\|District Zone: Operations (STRSM Oracles)]]** |
