...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Districts^Production-Area]]` | Guidance
...
^table-Production-Area

## Oracle: District Zone Production - Feature
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Districts^Production-Feature]]` | Guidance
...
^table-Production-Feature

## Oracle: District Zone Production - Peril
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Districts^Production-Peril]]` | Guidance
...
| 99 - 100 | Roll twice |
^table-Production-Peril

## Oracle: District Zone Production - Opportunity
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Districts^Production-Opportunity]]` | Guidance
...
| :--- | :---: | ---: |
| **[[STRSM_OCL_District-Zone-Operations\|District Zone: Operations (STRSM Oracles)]]** | #Starsmith/Oracles/Districts | **[[STRSM_OCL_District-Zone-Research\|District Zone: Research (STRSM Oracles)]]** |
