...
> [!mechanics]- | Roll ><br>▶[[STRSM_OCL_Core Action-Theme|A+T (STRSM)]] `dice: [[OT_STRSM_OCL_Core^Action]]` + `dice: [[OT_STRSM_OCL_Core^Theme]]`<br>▶[[STRSM_OCL_Character-Drives#Oracle Character Goal|Character Goal (STRSM)]]  `dice: [[OT_STRSM_OCL_Characters#^Goal]]`<br>▶Table Below: `dice: [[OT_STRSM_OCL_Campaign#^Inciting-Incident]]` | Guidance
...
> - Pick or roll on the table below. ^guidance-Inciting-Incident
...
| :--- | :---: | ---: |
| **[[STRSM_OCL_Sector Trouble\|Sector Trouble (STRSM Oracles)]]** | #Starsmith/Oracles/Campaign | **[[_STRSM_OCL_Core Oracles\|Core (STRSM Oracles)]]** |
