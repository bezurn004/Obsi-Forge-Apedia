...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Campaign#^Starship-History]]` | Guidance
> Envision how you obtained or earned this ship. You can come up with your own origin, or roll or pick from the table below. If you use a result from the table, take a moment to consider and elaborate on the suggestion. ^guidance-Starship-History
...
| :--- | :---: | ---: |
| **[[STRSM_OCL_Backstory Prompt\|Backstory Prompt (STRSM Oracles)]]** | #Starsmith/Oracles/Campaign | **[[STRSM_OCL_Starship Quirk\|Starship Quirks (STRSM Oracles)]]** |
