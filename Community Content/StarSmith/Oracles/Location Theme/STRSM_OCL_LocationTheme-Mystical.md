...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Loc-Theme^Mystic-Feature]]` | Guidance
...
^table-Mystic-Feature

## Oracle: Location Theme - Mystic Peril
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Loc-Theme^Mystic-Peril]]` | Guidance
...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Loc-Theme^Mystic-Opportunity]]` | Guidance
...
^table-Mystic-Opportunity

## Tags
| Previous Page | Tags | Next Page | 
| :--- | :---: | ---: |
| **[[STRSM_OCL_LocationTheme-Lifeform\|Location Theme: Lifeform (STRSM Oracles)]]** | #Starsmith/Oracles/LocationThemes | **[[STRSM_OCL_LocationTheme-Overgrown\|Location Theme: Overgrown (STRSM Oracles)]]** |
