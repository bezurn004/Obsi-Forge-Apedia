...
> [!mechanics]- | Roll > `dice: [[OT_STRSM_OCL_Derelicts#^Outer-First-Look]]` | Guidance
> What you notice from an outside inspection or scan. ^guidance-Outer-First-Look
...
> [!mechanics]- | Roll > <br>▶1 `dice: [[OT_STRSM_OCL_Derelicts#^Inner-First-Look]]`<br>▶2 `dice: [[OT_STRSM_OCL_Derelicts#^Inner-First-Look]]` | Guidance
> If you go inside the derelict, this is the first thing you notice. ^guidance-Inner-First-Look
...
^table-Inner-First-Look

## Tags
| Previous Section | Tags | Next Section | 
| :--- | :---: | ---: |
| **[[_STRSM_OCL_Derelict Oracles\|Derelict (STRSM Oracles)]]** | #Starsmith/Oracles/Derelicts | **[[_STRSM_OCL_District Oracles\|District (STRSM Oracles)]]** |
