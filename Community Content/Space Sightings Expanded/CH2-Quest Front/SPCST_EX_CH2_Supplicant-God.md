...
## Page
aliases:
  - "The Supplicant God (Space Sightings Expanded)"
PageType: "Quest Front"
PageCategory: Narrative
PageOrder: 13
---
# [[_Space Sightings Expanded|Space Sightings Expanded]] - [[_SPCST_EX_CH2_Quest-Front|Quest Front]]: The Supplicant God
...
- **Achoront:** A ==**▶[[SPCST_EX_CH1_Rogue-Asteroid|Large Rogue Asteroid]]**== of titanic size located in a recondite space far from inhabited solar systems. It was at these coordinates that we received a distress call from the ship that was abducted by the Shattered Flames. The ship in question was the one corresponding with researchers of the Coalition of Golden Heralds, who were taking a course to another settlement to take data for their studies.
  ...
  It is believed that the criminal faction has some settlements on this asteroid, although we know from corrected data that their size is not limited to this sector of the known galaxy and that they are a nomadic faction. What is the purpose of this settlement? Why would [[SPCST_EX_CH2_Shattered-Flames|Shattered Flames]] kidnap a squad of Coalition of Golden Heralds researchers?
...
| :--- | :---: | ---: |
| **[[_SPCST_EX_CH2_Quest-Front\|Quest Front (Space Sightings Expanded)]]** | #SpaceSightingsExpanded/QuestFront | **[[SPCST_EX_CH2_Kamarakon-Dynasty\|Faction - Kamarakon Dynasty (Space Sightings Expanded)]]** |
