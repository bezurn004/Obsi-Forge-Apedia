...
## Page
aliases:
  - "Chapter 2: Getting Underway - Full (Sundered Isles)"
...
- **Carefully consider the representation of slavery in your campaign.** The slave trade was an abhorrent reality of the colonial age, but is not assumed to be an aspect of the _Sundered Isles_. For you or another player, any depiction of slavery may be harmful or unwanted content. Discuss this in the context of your worldbuilding and [[SI_CH4_Full#SET A FLAG|Set a Flag]] as needed. If slavery is a reality in your setting, do not trivialize or romanticize it.
- 
*66 GETTING UNDERWAY*

## SUPPORT PLAYER SAFETY
As you work through the campaign launch exercises and anytime during play, use the [[SI_CH4_Full#SET A FLAG|Set a Flag]] to identify content boundaries and to prioritize player safety, comfort, and fun over the narrative. This can include content that will be omitted, modified, or addressed on a case-by-case basis if it is encountered in your game.

Work with other players to ensure a collaborative environment where everyone can [[SI_CH4_Full#SET A FLAG|Set a Flag]]. But keep in mind that using this move should not force a discussion of a content boundary. Players do not need to provide details or justification. If that is their wish, note the flagged content and move on.

![[SI_CH4_Full#SET A FLAG]]
...
You can also generate details with the [[SI_CH3_Full#FACTION ORACLES|Faction Oracles]] (page 176). Or use real-world history, other games, or media for inspiration—adjust and reimagine as needed.
...
Give each faction a relationship with at least one other faction. If you’re unsure, choose two factions, and use the table below to help frame the relationship of one to another. Reroll or adjust any result that doesn’t fit, or consider how that result might signal an unexpected relationship. If you’d like more options, you can also use the expanded version of this table [[SI_CH3_Full#FACTION RELATIONSHIP| on page 177]].
...
If helpful, you can create a relationship map for factions as described on [[SI_CH1_Full#FACTION RELATIONSHIP MAPS|page 51]]. But it might be best to save that for later. Let the factions and their relationships deepen through a session or two, and take what you’ve learned to craft a relationship map.
...
Envision the broad strokes of your character concept. Who are you? What drives you? Keep in mind these pillars (see [[SI_CH1_Full#YOUR CHARACTER|page 10 for details]]).
...
Select two path assets from your _Sundered Isles_ deck ([[SI_CH1_Full#Asset Guide|pages 14–15]]). Choose assets that support an interesting character concept, reflect the nature of your world, and foster the stories that you and other players want to explore.
...
As you begin this exercise, ready your deck using the outline and suggestions on [[SI_CH1_Full#Asset Guide|pages 14–15]].
...
Give your character a name. For inspiration, check the [[SI_CH3_Full#CHARACTER NAME|Names table on page 194]]. If you are known by a moniker or title, note that as well. Then, mark down your character’s pronouns.

### STEP 5: WRITE YOUR BACKGROUND VOW
What ambition, need, or commitment drives you? This is your background vow. Mark the vow and give it an epic rank. If you’re not sure, save it for later—or look for inspiration on an oracle table such as [[SI_CH3_Full#CHARACTER GOALS|Character Goals]] (page 193).
...
- **What aspects of your look or personality are obvious at first glance?** Roll or choose once or twice on the [[SI_CH3_Full#CHARACTER FIRST LOOK|Character First Look]] table (page 186).
- **What is your former or current profession?** Roll or choose once on the [[SI_CH3_Full#CHARACTER ROLES|Character Roles]] table (page 187), then roll or choose on a [[SI_CH3_Full#CHARACTER ROLE DETAILS|Character Role Details]] subtable (pages 188–189).
- **What accessory or piece of gear helps define your look?** Roll or choose once or twice on the [[SI_CH3_Full#TRADEMARK ACCESSORIES|Trademark Accessories]] table (page 190).
- **If you are armed, what is your favored weapon?** Roll or choose once on the [[SI_CH3_Full#TRADEMARK WEAPONS|Trademark Weapons]] table (page 191).
- **What are less-obvious or hidden aspects of your nature?** Roll or choose once or twice on the [[SI_CH3_Full#CHARACTER DETAILS|Character Details]] table (page 192).
- **What drives you?** Roll or choose once or twice on the [[SI_CH3_Full#CHARACTER GOALS|Character Goals]] table (page 193).
- **You possess an object of personal significance. What is it?** Roll or choose once on the [[SI_CH3_Full#TOKENS|Tokens]] table (page 223).
- 
...
> For a complete list of recommended _Sundered Isles_ and _Starforged_ assets, [[SI_CH1_Full#Asset Guide|see (pages 14–15)]]. The table _above_ features path assets from this curated deck.
...
> 
> Take the [[AST_Flagship|FLAGSHIP]] command vehicle asset. This asset is normally gained when you [[SI_CH4_Full#ADVANCE|Advance]] and spend experience. But as a seasoned commander, you skip the queue and claim this prize at the start of your story. Learn more about the [[AST_Flagship|FLAGSHIP]] asset on [page 18].
...
- **What size is the ship?** Roll or choose once on the [[SI_CH3_Full#SHIP SIZE|Ship Size]] table (page 132). Ignore or reroll the “Force” results.
- **What aspects of the ship’s look or nature are obvious when first sighted?** Roll or choose once or twice on the [[SI_CH3_Full#SHIP FIRST LOOK|Ship First Look]] table (page 134).
- **What symbol does it bear on its flag or as a design motif?** Roll or choose once on the [[SI_CH3_Full#SHIP SYMBOL|Ship Symbol]] table (page 136).
- **What are less-obvious or hidden aspects of the ship or its crew?** Roll or choose once or twice on the [[SI_CH3_Full#SHIP DETAILS|Ship Details]] table (page 138).
- **What cargo does it currently carry?** Roll or choose up to three times on the [[SI_CH3_Full#CARGO|Cargo]] table (page 139).
- **What is the ship’s name?** Roll or choose on the [[SI_CH3_Full#SHIP NAME|Ship Name]] table (page 140).
...
For now, focus on the crew as a whole. Later, you can personalize key individual crewmembers. [[SI_CH1_Full#COMMAND AND CREWS|See page 22]] for more on envisioning and managing a crew.
...
Choose a final asset from these categories: ==Support Vehicle==, ==Module== (only if you command a [[AST_Flagship|FLAGSHIP]]), ==Path==, or ==Companion==. For the full list of recommended _Sundered Isles_ assets, [[SI_CH1_Full#Asset Guide|see pages 14–15]].

Do not choose a Deed asset for your starting character. Those represent notable achievements and situations in your story, and are taken when you [[SI_CH4_Full#ADVANCE|Advance]].
...
Learn more about [[SI_CH1_Full#CHARTING YOUR COURSE|navigation charts]] on page 34.
...
- [[SI_CH3_Full#ISLAND ORACLES|Island Oracles]] (page 142)
- [[SI_CH3_Full#^Settlement-Oracles|Settlement Oracles]] (page 164)
- [[SI_CH3_Full#CHARACTER ORACLES|Character Oracles]] (page 186).
...
Later in this exercise, you reference this grid to decide which factions have control of a key settlement. To learn more about the [[SI_CH1_Full#FACTION INFLUENCE GRID|faction influence grid]], see page 50.
...
> ### [[SI_CH3_Full#ISLAND ORACLES|ISLAND ORACLES]]
> Page 142
...
- **What is the island’s landscape?** Roll or choose on the _[[SI_CH3_Full#SIZE|Size]]_, _[[SI_CH3_Full#TERRAIN|Terrain]]_, and _[[SI_CH3_Full#VITALITY|Vitality]]_ tables (page 142), and take a moment to consider what those results imply about the location. Larger islands likely have varying landscapes, but these initial results are the dominant characteristics.
...
- **Are there neighboring islands?** Roll or choose on the _[[SI_CH3_Full#NEARBY ISLANDS|Nearby Islands]]_ table (page 143). If the island is part of a pair or group, add the minor islands to the map near the main island. In favorable weather, the members of an island pair or group are close enough to be visible from one another, requiring a short sail to travel from one to another. Keep it simple; the central island is your focus. You won’t generate details for the neighboring isles in this exercise, and they don’t count toward the number of islands in the region. They are like moons orbiting a home world.
- **What is its name?** Roll or choose on the _[[SI_CH3_Full#ISLAND NAME|Island Name]]_ table (page 147).
...
> ### [[SI_CH3_Full#^Settlement-Oracles|SETTLEMENT ORACLES]]
> Page 164
...
- **How populous is the settlement?** Roll or choose on the _[[SI_CH3_Full#SETTLEMENT SIZE]]Settlement Size_ table (page 164).
- **What are the primary industries or activities?** Roll or choose on the _[[SI_CH3_Full#SETTLEMENT FOCUS\|Settlement Focus]]_ table (page 168), referencing the shore column.
...
- **What is its name?** Roll or choose on the _[[SI_CH3_Full#SETTLEMENT NAME|Settlement Name]]_ table (page 175).
...
- **What is the ambiance and architecture?** Roll or choose on the _[[SI_CH3_Full#SETTLEMENT AESTHETICS|Settlement Aesthetics]]_ table (page 165).
- **What is seen at first glance?** Roll or choose on the _[[SI_CH3_Full#SETTLEMENT FIRST LOOK|Settlement First Look]]_ table (page 166).
- **What else do I know of this place?** Roll on the _[[SI_CH3_Full#SETTLEMENT DETAILS|Settlement Details]]_ table (page 170) to reveal additional aspects or rumors.
...
> ### [[SI_CH3_Full#CHARACTER ORACLES|CHARACTER ORACLES]]
> Page 186
...
- **What is their rank?** The connection’s rank represents the challenge of advancing the relationship. The higher the rank, the greater the narrative focus and trouble involved to eventually [[SI_CH4_Full#FORGE A BOND|Forge a Bond]] with them. Choose a rank appropriate to their role and the level of involvement you want them to have in your story: troublesome, dangerous, formidable, extreme, or epic.
- **What drives them?** Roll or choose on the _[[SI_CH3_Full#CHARACTER GOALS|Character Goals]]_ table (page 193).
- **What is their name?** Roll or choose on the _[[SI_CH3_Full#CHARACTER NAME|Character Name]]_ table (page 194).
...
- **What are obvious characteristics of the connection?** Roll or choose on the [[SI_CH3_Full#CHARACTER FIRST LOOK|Character First Look]] table (page 186).
- **What item or gear is this person seldom without?** Roll or choose on _[[SI_CH3_Full#TRADEMARK ACCESSORIES|Trademark Accessories]]_ (page 190) or _[[SI_CH3_Full#TRADEMARK WEAPONS|Trademark Weapons]]_ (page 191).
  **What have I learned of this connection over time?** Roll or choose on the _[[SI_CH3_Full#CHARACTER DETAILS|Character Details]]_ table (page 192).
...
> ### [[SI_CH3_Full#LOCAL SEAS|LOCALSEAS]]
> Page 227
...
Near the start of your story, you [[SI_CH4_Full#SWEAR AN IRON VOW|Swear an Iron Vow]] to follow a goal, face a problem, or undertake a mission. This inciting incident interrupts the status quo and propels you into action. Make it a dangerous or troublesome quest.
...
- A task from a patron or connection: _[[SI_CH3_Full#ACTION|Action]]_ + _[[SI_CH3_Full#THEME|Theme]]_ (pages 116–117)
- An incident at sea: _[[SI_CH3_Full#SEAFARING PERIL|Seafaring Peril]]_ (page 128)
- A personal mission: _[[SI_CH3_Full#CHARACTER GOALS|Character Goals]]_ (page 193)
- A mysterious treasure map: _[[SI_CH3_Full#TREASURE LOCATION|Treasure Location]]_ (page 220)
...
|:--- |:---:| ---:|
| **[[SI_CH1_Full\|Chapter 1: Adventure Among the Isles - Full (Sundered Isles)]]** | #SunderedIsles/Campaign/Full | **[[SI_CH3_Full\|Chapter 3: Oracles - Full (Sundered Isles)]]** |
