...
## PICK YOUR POISON
When you [[SI_CH4_Full#ASK THE ORACLE|Ask the Oracle]] a question that leads you to this section, consider your approach and preferences. For any particular situation, you might have several tables to choose from.
...
Other oracle results are general. They provide room to clarify or expand, but are less cryptic than the abstract tables. For example, the _[[#SEAFARING PERIL|Seafaring Peril]]_ table (page 128) includes prompts for unfortunate events that might befall your ship, but the exact nature of each event is left to the players to suss out. You may decide those answers yourself, or [[SI_CH4_Full#ASK THE ORACLE|Ask the Oracle]] yes/no questions to clarify.

And some oracle tables are specific. A _[[#CHARACTER NAME|Character Name]]_ (page 194), for example. Or _[[#OVERLAND DETAILS|Overland Details]]_ (page 156). The more precise the result, the more flavorful or actionable, but the less open to creative interpretation. This is especially true when playing in the world of the _Sundered Isles_, because the oracle tables are keyed to the setting. If you are playing in another world, or chose to explore the skyfaring or spacefaring realms when you [[SI_CH2_Full#SELECT YOUR REALM|launched your campaign]] (page 69), you may find abstract and general prompts more useful.
...
# CORE ORACLES
When you [[SI_CH4_Full#ASK THE ORACLE|Ask the Oracle]] about a goal, situation, or event, roll for an _[[#ACTION|Action]] below_) and _[[#THEME|Theme]]_ (next page). Together, these tables provide a verb/noun phrase.
...
## DESCRIPTOR
When you [[SI_CH4_Full#ASK THE ORACLE|Ask the Oracle]] about the nature of a location, discovery, or encounter, roll for a _[[#DESCRIPTOR|Descriptor]] (below)_ and a _[[#FOCUS|Focus]]_ (next page). Together, these tables provide an adjective/noun phrase.
...
# SEAFARING ORACLES
Use these tables to trigger locations, events, and encounters on a seafaring expedition. Use the _[[#KNOWN WATERS|Known Waters]]_ table (below) if you [[SI_CH4_Full#UNDERTAKE AN EXPEDITION|Undertake an Expedition]] among or between known islands, such as when following a chart of local islands. Use the _[[#UNKNOWN WATERS|Unknown Waters]]_ table (next page) when navigating unfamiliar waters with the prospect of encountering unrevealed islands. ^Seafaring-Oracles
...
If you face a cost in your travels, such as when you roll a miss as you [[SI_CH4_Full#UNDERTAKE AN EXPEDITION|Undertake an Expedition]], the _[[#SEAFARING PERIL|Seafaring Peril]]_ (pg 128) oracle can help reveal what occurs. If you encounter good fortune, such as when you roll a strong hit with a match, the _[[#SEAFARING OPPORTUNITY|Seafaring Opportunity]]_ (page 129) table can inspire the nature of this lucky break. Check those tables instead of—or in addition to—a seafaring waypoint.
...
Use this table when you want inspiration for a beneficial encounter or event on a seagoing journey, such as when you roll a strong hit with a match as you [[SI_CH4_Full#UNDERTAKE AN EXPEDITION|Undertake an Expedition]],  or if you [[SI_CH4_Full#EXPLORE A WAYPOINT|Explore a Waypoint]] and find an opportunity.
...
If the first impressions of a ship don’t reveal its identity, check the table below. If a known faction commands the ship, roll or choose on your [[SI_CH1_Full#FACTION INFLUENCE GRID|faction influence grid]] (page 50). If it is independent or aligned with an Unknown faction, use other tables such as _[[#SHIP SYMBOL|Ship Symbol]]_ and _[[#SHIP MISSION|Ship Mission]]_ to help envision its nature, allegiances, and purpose.
...
If you face a cost in your travels, such as when you roll a miss as you [[SI_CH4_Full#UNDERTAKE AN EXPEDITION|Undertake an Expedition]], the _[[#OVERLAND PERIL|Overland Peril]]_ table (page 162) can help reveal what occurs. If you encounter good fortune, such as when you roll a strong hit with a match, the _[[#OVERLAND OPPORTUNITY|Overland Opportunity]]_ table (page 163) can inspire the nature of this lucky break. Check those tables instead of—or in addition to—an overland waypoint.
...
| 46 - 50 | Narrow trail through steep-sided ravine |
...
## OVERLAND PERIL
Use this table when you want inspiration for a trouble during island exploration or on an overland expedition.
...
Use this table when you want inspiration for a beneficial encounter or event on an overland journey, such as when you roll a strong hit with a match as you [[SI_CH4_Full#UNDERTAKE AN EXPEDITION|Undertake an Expedition]], or if you [[SI_CH4_Full#EXPLORE A WAYPOINT|Explore a Waypoint]] and find an opportunity.
...
Use this table to reveal the ambiance and architecture of the settlement. Smaller settlements likely have a single style, while larger settlements might have multiple styles across sections or districts. 
...
| 31 - 32 | Displaying trophies of defeated foes |
...
## [skull] CURSED SETTLEMENT FIRST LOOK
...
## SETTLEMENT IDENTITY
If the settlement’s location or your initial impression doesn’t reveal its identity, check the _[[#SETTLEMENT CONTROLLING FACTION|Controlling Faction]]_ table below. If this place is inhabited or overseen by a known faction, roll or choose on your [[SI_CH1_Full#FACTION INFLUENCE GRID|faction influence grid]] (page 50). If it is independent or aligned with an unknown faction, use the _[[#SETTLEMENT DISPOSITION|Disposition]]_ and _[[#SETTLEMENT AUTHORITY|Authority]]_ tables to help envision the reaction to your arrival and the apparent nature of the leadership.
...
## [skull] CURSED SETTLEMENT FOCUS6
If you roll a Settlement Focus curse, take your result on that table and make note that it is cursed. Something about this activity has an uncanny or dreadful aspect. If you investigate or interact further, use the table below to help reveal the industry’s relationship to a cursed power.
...
## [skull] CURSED SETTLEMENT DETAILS
...
Optionally, create a compound name for a settlement by taking your result and adding a word from this list. For example, Moonstone Bay or Mournhaunt Crossing.
...
When you have a question about the relationship of one faction to another—or how an individual relates to a faction—use this table. The result is the commonly understood connection, but might not tell the whole story.
...
For details on using factions in your campaign, [see page 48]
...
| 34 - 35 | Faced the wasting of a place or resource |
...
### SOCIETY TOUCHTSTONE
These touchstones represent common aspects of a society—not universal truths. Individual people and communities can contradict these assumptions with their own touchstones. If you encounter a far-flung community that is part of a known society, you can recheck this table for unique characteristics. 
...
| 12 | Practices mysticism or magic |
...
| 69 - 70 | Holds tournaments of skill or prowess |
...
### IMPERIAL TACTICS
Empires deploy any number of strategies to expand their power and influence. Use this table to reveal the most visible methods or a current focus for an empire.
...
### [skull] CURSED FACTION ASPECTS

Use this table to reveal uncanny aspects of a faction or its members. 
...
## [skull] CURSED CHARACTER FIRST LOOK
...
| 29 - 30 | Elaborate masquerade mask |
...
| 82 - 84 | Shrapnel-filled iron grenades |
...
## [skull] CURSED WEAPON DETAIL
If you roll a Trademark Weapon curse, take your result and give that weapon a cursed aspect from the table below.
...
## [skull] CURSED CHARACTER DETAILS
...
| 65 - 66 | Protect or support a person |
...
Use this table to reveal the characteristics of the wreck and its surroundings—as perceived on approach.
...
| 48 - 50 | Overtaken by malignant plants |
...
### EXPLORING A WRECK
If you divert to search a shipwreck in the midst of an expedition, make the [[SI_CH4_Full#EXPLORE A WAYPOINT|Explore a Waypoint]]. Per the move, a strong hit is an opportunity, a weak hit is an opportunity bound up with a peril, and a miss is an immediate hardship or threat. Use the _[[#SHIPWRECK OPPORTUNITY|Shipwreck Opportunity]]_ (page 203) and _[[#SHIPWRECK PERIL|Shipwreck Peril]]_ (page 203) tables to help envision those outcomes.

A strong hit with a match or a miss with a match as you [[SI_CH4_Full#EXPLORE A WAYPOINT|Explore a Waypoint]] can trigger the [[SI_CH4_Full#MAKE A DISCOVERY|Make a Discovery]] or [[SI_CH4_Full#CONFRONT CHAOS|Confront Chaos]], respectively. Use the tables within those moves to envision what you find. These aredramatic, story-changing moments.

### INVESTIGATING A WRECK
If you investigate a shipwreck for clues related to a quest, make the [[SI_CH4_Full#GATHER INFORMATION|Gather Information]]. Use the outcome of the move to help guide the nature of what you uncover—whether that discovery is favorable or unfavorable. For inspiration, use the _[[#STORY CLUE|Story Clue]]_ table (page 231).
...
## SHIPWRECK DETAILS
Use this table to reveal details of a wreck. Roll once or twice when searching a small ship, and up to three times when surveying a large vessel. These details are revealed in the context of another move—such as [[SI_CH4_Full#EXPLORE A WAYPOINT|Explore a Waypoint]] or [[SI_CH4_Full#GATHER INFORMATION|Gather Information]]—but might prompt additional actions or investigations. [[#SUMMARY EXPLORING A SHIPWRECK|See page 201]] for details on searching a wreck.
...
> # CAVE ORACLES ^Cave-Oracles

## CAVE TYPE
When learning about a distant cave, use the table below to reveal its location. If you come upon a cave in your travels, pick a location as appropriate to your surroundings.
...
When you [[SI_CH4_Full#FINISH AN EXPEDITION|Finish An Expedition]], envision what lies at the cave’s heart, or use the table included with each cave type for inspiration. Once you reach a cave’s heart and resolve the expedition, you can [[SI_CH4_Full#SET A COURSE|Set a Course]] to shortcut your exit.

*206 ORACLES*

## LURKING THREAT | [skull] _below_
...
| 66 - 67 | Rocky island surrounded by water |
...
### [skull] INLAND CAVE CURSED FEATURES
...
> # RUIN ORACLES ^Ruin-Oracles

## RUIN LOCATION

When learning about a distant ruin, use this table to reveal its location. If you come upon a ruin in your travels, pick a location as appropriate to your surroundings.
...
| 67 - 69 | Suffused with eerie light |
...
Use the [[SI_CH4_Full#^Exploration-Moves|exploration moves]] (page 242) to investigate a notable ruin. If you are diverting from an overland or seafaring expedition to check out a ruin of minor scale, you can [[SI_CH4_Full#EXPLORE A WAYPOINT|Explore a Waypoint]] to resolve the survey with a single move. For a larger ruin, give it a challenge rank as you begin a new expedition. Then, within a ruin, use the _[[#RUIN FEATURES|Features]]_ table to inspire the details of a waypoint, the _[[#RUIN PERIL|Peril]]_ table when you face a cost, and the _[[#RUIN OPPORTUNITY|Opportunity]]_ table if you encounter good fortune.
...
- After that, as you reach a waypoint and mark progress, you can envision uncovering a cipher—a feature, object, or encounter that delivers a new clue. Use the _[[#RUIN CIPHER|Ruin Cipher]]_ table (page 216) for inspiration of what form it takes. For details of the clue itself, [[SI_CH4_Full#ASK THE ORACLE|Ask the Oracle]] yes/no questions, use _[[#CORE ORACLES|Core Oracles]]_ (pages 116–119) for an abstract prompt, or check the _[[#STORY CLUE|Story Clue]]_ table (page 231). If the nature of the cipher is complex or inscrutable, such as a puzzle or cryptic message, make appropriate moves to reveal or understand the clue. Envision how the clue fits into the evolving nature of the mystery, while leaving unanswered questions.
- When you prepare to [[SI_CH4_Full#FINISH A SCENE|Finish a Scene]], consider the nature of the mystery and the clues you have uncovered, and propose a solution. The outcome of the progress roll as you [[SI_CH4_Full#FINISH A SCENE|Finish a Scene]] reveals whether your assumptions are correct, or if you have been led astray.
...
| 70 | Scattered animal bones and detritus |
...
| 73 - 74 | Remains of a monstrous beast |
...
For tips on managing treasure and wealth in your campaign, see [[SI_CH1_Full#WEALTH AND TREASURE|page 28]].
...
A trove or hoard contains a vast array of riches. Collecting and transporting a trove requires great effort, while the logistics of gathering a hoard is an inconceivable task.
...
| 74 | Set of crystal and obsidian chess pieces |
...
*225 TREASURE ORACLES*

> # MISCELLANEOUS ORACLES ^Misc-Oracles
...
## LOCAL SEAS
To generate a name for a local area—a collection of islands and surrounding waters—roll once for the prefix (the first word), and once for the suffix (the second word). Or just roll once, and choose a suitable prefix and suffix from anywhere in that row.
...
## STORY COMPLICATION
This oracle will introduce narrative turns, troubles, and revelations. It can be used as an alternative to the [[SI_CH4_Full#PAY THE PRICE|Pay the Price]] table when you encounter a negative outcome at a crucial moment. In particular, you might use this table after rolling matched 10s on the challenge dice.
...
## STORY CLUE
When you [[SI_CH4_Full#GATHER INFORMATION|Gather Information]] to investigate a mystery, you might uncover clues in the form of messages, records, rumors, eyewitness reports, or physical evidence. You can use this oracle to help reveal what this evidence connects to or implicates. Then, use the outcome of the [[SI_CH4_Full#GATHER INFORMATION|Gather Information]] roll—strong hit, weak hit, or miss—to guide whether the clue brings clarity or complications.
...
## COMBAT ACTION
Use this oracle to help inspire an action for a foe in a fight. When you’re not sure what an enemy does next, particularly when they have you in a bad spot, roll on this table and interpret the result as appropriate to the nature of the enemy and battleground.
