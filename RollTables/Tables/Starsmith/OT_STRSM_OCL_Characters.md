...
| 89 - 90 | Technician |
| 91 - 92 | Thief |
| 93 - 95 | ▶[[OT_STRSM_OCL_Core#Action\|A]] `dice: [[OT_STRSM_OCL_Core#^Action]]` + ▶[[OT_STRSM_OCL_Core#Theme\|T]] `dice: [[OT_STRSM_OCL_Core#^Theme]]` |
| 96 - 100 | ▶R2 `dice: [[OT_STRSM_OCL_Characters^Role]]` + `dice: [[OT_STRSM_OCL_Characters^Role]]` |
...
| 193 - 195 | ▶[[OT_STRSM_OCL_Core#Action\|A]] `dice: [[OT_STRSM_OCL_Core#^Action]]` + ▶[[OT_STRSM_OCL_Core#Theme\|T]] `dice: [[OT_STRSM_OCL_Core#^Theme]]` |
| 196 - 200 | ▶R2 `dice: [[OT_STRSM_OCL_Characters^Role]]` + `dice: [[OT_STRSM_OCL_Characters^Role]]` |
| 201 - 202 | Alchemist |
...
| 293 - 295 | ▶[[OT_STRSM_OCL_Core#Action\|A]] `dice: [[OT_STRSM_OCL_Core#^Action]]` + ▶[[OT_STRSM_OCL_Core#Theme\|T]] `dice: [[OT_STRSM_OCL_Core#^Theme]]` |
| 296 - 300 | ▶R2 `dice: [[OT_STRSM_OCL_Characters^Role]]` + `dice: [[OT_STRSM_OCL_Characters^Role]]` |
^Role
...
| 81 - 90 | ▶[[STRSM_OCL_Core Action-Theme#Oracle Action\|A]] `dice: [[OT_STRSM_OCL_Core#^Action]]` + ▶[[STRSM_OCL_Core Action-Theme#Oracle Theme\|T]] `dice: [[OT_STRSM_OCL_Core#^Theme]]` |
| 91 - 100 | ▶R2 `dice: [[OT_STRSM_OCL_Characters#^Goal]]` + `dice: [[OT_STRSM_OCL_Characters#^Goal]]` |
...
| 181 - 190 | ▶[[STRSM_OCL_Core Action-Theme#Oracle Action\|A]] `dice: [[OT_STRSM_OCL_Core#^Action]]` + ▶[[STRSM_OCL_Core Action-Theme#Oracle Theme\|T]] `dice: [[OT_STRSM_OCL_Core#^Theme]]` |
| 191 - 200 | ▶R2 `dice: [[OT_STRSM_OCL_Characters#^Goal]]` + `dice: [[OT_STRSM_OCL_Characters#^Goal]]` |
...
| 281 - 290 | ▶[[STRSM_OCL_Core Action-Theme#Oracle Action\|A]] `dice: [[OT_STRSM_OCL_Core#^Action]]` + ▶[[STRSM_OCL_Core Action-Theme#Oracle Theme\|T]] `dice: [[OT_STRSM_OCL_Core#^Theme]]` |
| 291 - 300 | ▶R2 `dice: [[OT_STRSM_OCL_Characters#^Goal]]` + `dice: [[OT_STRSM_OCL_Characters#^Goal]]` |
^Goal

# Revealed Aspect

| dice: 1d300 | Result @1-3 |
| :---: | --- |
| 1 - 1 | Addicted |
| 2 - 2 | Adventurous |
| 3 - 3 | Afflicted |
