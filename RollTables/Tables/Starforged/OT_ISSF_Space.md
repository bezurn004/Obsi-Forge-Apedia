...
| 48 - 51 | ▶[[SF_CH5_Derelict_Create\|Derelict]] Create New |
| 52 - 53 | ▶[[SF_CH5_Vault-Exterior\|Precursor Vault]] Create New |
| 54 - 55 | ▶[[SF_CH5_Creature-Basic Form\|Creature]] Create New |
| 56 - 60 | ▶[[OT_ISSF_Core#Descriptor\|D]] `dice: [[OT_ISSF_Core#^Descriptor]]` + ▶[[OT_ISSF_Core#Focus\|F]] `dice: [[OT_ISSF_Core#^Focus]]` |
...
| 94 - 98 | ▶R2 `dice: [[OT_ISSF_Space#^Sighting-Terminus]]` + `dice: [[OT_ISSF_Space#^Sighting-Terminus]]` |
| 99 - 100 | ▶R3 `dice: [[OT_ISSF_Space#^Sighting-Terminus]]` + `dice: [[OT_ISSF_Space#^Sighting-Terminus]]` + `dice: [[OT_ISSF_Space#^Sighting-Terminus]]` |
^Sighting-Terminus
...
| 1 - 15 | ▶[[OT_ISSF_Space#Stellar Object\|Stellar Object]] |
| 16 - 35 | ▶[[OT_ISSF_Planets#Type - Short\|Planet]] Create New |
| 36 - 38 | ▶[[SF_CH5_Settle-Creation\|Settlement]] Create New |
| 39 - 43 | ▶[[OT_ISSF_Starships#Type\|Starship]] Create New |
| 44 - 46 | ▶[[SF_CH5_Derelict_Create\|Derelict]] Create New |
| 47 - 49 | ▶[[SF_CH5_Vault-Exterior\|Precursor Vault]] Create New |
| 50 - 52 | ▶[[SF_CH5_Creature-Basic Form\|Creature]] Create New |
| 53 - 58 | ▶[[OT_ISSF_Core#Descriptor\|D]] `dice: [[OT_ISSF_Core#^Descriptor]]` + ▶[[OT_ISSF_Core#Focus\|F]] `dice: [[OT_ISSF_Core#^Focus]]` |
...
| 86 - 93 | Dense nebula cloud |
| 94 - 98 | ▶R2 `dice: [[OT_ISSF_Space#^Sighting-Outlands]]` + `dice: [[OT_ISSF_Space#^Sighting-Outlands]]` |
| 99 - 100 | ▶R3 `dice: [[OT_ISSF_Space#^Sighting-Outlands]]` + `dice: [[OT_ISSF_Space#^Sighting-Outlands]]` + `dice: [[OT_ISSF_Space#^Sighting-Outlands]]` |
^Sighting-Outlands
...
| 1 - 15 | ▶[[OT_ISSF_Space#Stellar Object\|Stellar Object]] |
| 16 - 35 | ▶[[OT_ISSF_Planets#Type - Short\|Planet]] Create New |
| 36 - 37 | ▶[[SF_CH5_Settle-Creation\|Settlement]] Create New |
| 38 - 39 | ▶[[OT_ISSF_Starships#Type\|Starship]] Create New |
| 40 - 41 | ▶[[SF_CH5_Derelict_Create\|Derelict]] Create New |
| 42 - 45 | ▶[[SF_CH5_Vault-Exterior\|Precursor Vault]] Create New |
| 46 - 49 | ▶[[SF_CH5_Creature-Basic Form\|Creature]] Create New |
| 50 - 56 | ▶[[OT_ISSF_Core#Descriptor\|D]] `dice: [[OT_ISSF_Core#^Descriptor]]` + ▶[[OT_ISSF_Core#Focus\|F]] `dice: [[OT_ISSF_Core#^Focus]]` |
...
| 86 - 93 | Dense nebula cloud |
| 94 - 98 | ▶R2 `dice: [[OT_ISSF_Space#^Sighting-Expanse]]` + `dice: [[OT_ISSF_Space#^Sighting-Expanse]]` |
| 99 - 100 | ▶R3 `dice: [[OT_ISSF_Space#^Sighting-Expanse]]` + `dice: [[OT_ISSF_Space#^Sighting-Expanse]]` + `dice: [[OT_ISSF_Space#^Sighting-Expanse]]` |
^Sighting-Expanse
...
| 100 | ▶R2 `dice: [[OT_ISSF_Space#^Peril]]` + `dice: [[OT_ISSF_Space#^Peril]]` |
^Peril
