# Waypoints
#oraclegeneratobject (all waypoint tables below)

## Waypoint - Known Waters
...
| 26 - 65 | Lost souls ▶[[SI_CH3_Shipwreck_Creation#Oracle Shipwreck Location\|Shipwreck]]; _pg 198_ |
...
| 46 - 60 | Instance (choose one)<br>▶[[OT_ISSI_Seafaring#^Details\|Seafaring Details]] `dice: [[OT_ISSI_Seafaring#^Details]]`<br>▶[[OT_ISSI_Core#^Descriptor\|D]] `dice: [[OT_ISSI_Core^Descriptor]]` + ▶[[OT_ISSI_Core#^Focus\|F]] `dice: [[OT_ISSI_Core^Focus]]` |
...
| 41 - 55 | Instance (choose one)<br>▶[[OT_ISSI_Seafaring#^Details\|Seafaring Details]] `dice: [[OT_ISSI_Seafaring#^Details]]`<br>▶[[OT_ISSI_Core#^Descriptor\|D]] `dice: [[OT_ISSI_Core^Descriptor]]` + ▶[[OT_ISSI_Core#^Focus\|F]] `dice: [[OT_ISSI_Core^Focus]]` |
...
| 36 - 50 | Instance (choose one)<br>▶[[SI_CH3_Seafaring Details\|Seafaring Details]] `dice: [[SI_CH3_Seafaring Details^table-OclSeafaringDetails]]`<br>▶[[SI_CH3_Core_Descriptor Focus#DESCRIPTOR\|D]] + [[SI_CH3_Core_Descriptor Focus#FOCUS\|F]] `dice: [[SI_CH3_Core_Descriptor Focus^table-OclDescriptor]]` + `dice: [[SI_CH3_Core_Descriptor Focus^table-OclFocus]]` |
| 51 - 60 | ▶[[SI_CH3_Shipwreck_Creation#Oracle Shipwreck Location\|Shipwreck "Lost souls"]] `dice: [[SI_CH3_Shipwreck_Creation^table-OclShipwreckLocation]]` |
...
| 94 - 96 | ▶[[SI_CH3_Weather Oracles#Oracle Foul Weather\|Foul Weather]] `dice: [[SI_CH3_Weather Oracles^table-OclFoulWeather]]` |
| 97 - 99 | ▶[[SI_CH3_Core_Action Theme#ACTION\|A]]+[[SI_CH3_Core_Action Theme#THEME\|T]] `dice: [[OT_ISSI_Core^Action]]` + `dice: [[OT_ISSI_Core^Theme]]` |
| 100 | ▶R2 `dice: [[OT_ISSI_Seafaring#^Peril]]` + `dice: [[OT_ISSI_Seafaring#^Peril]]` |
^Peril
